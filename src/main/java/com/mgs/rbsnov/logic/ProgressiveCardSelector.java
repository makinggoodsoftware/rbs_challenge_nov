...
public class ProgressiveCardSelector implements CardSelector {
    ...
    public Card bestCard(DealInProgress dealInProgress, Set<Card> inPlay, Set<Card> myCards, Map<Player, Set<Card>> knownCards, Map<Player, Set<Suit>> missingSuits) {
        ...
        BestCardBundle input = new BestCardBundle(dealInProgress, inPlay, myCards, knownCards, missingSuits);
    ...
    public class BestCardBundle {
        ...
        public BestCardBundle(DealInProgress dealInProgress, Set<Card> inPlay, Set<Card> myCards, Map<Player, Set<Card>> knownCards, Map<Player, Set<Suit>> missingSuits) {
